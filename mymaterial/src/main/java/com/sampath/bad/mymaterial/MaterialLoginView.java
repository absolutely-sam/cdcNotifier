...
public class MaterialLoginView extends FrameLayout {
    ...
    private boolean floatingButtonClicked = true;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            registerUser.getEditText().setTextColor(getResources().getColor(R.color.material_login_register_text_color));
            registerPass.getEditText().setTextColor(getResources().getColor(R.color.material_login_register_text_color));
            registerPassRep.getEditText().setTextColor(getResources().getColor(R.color.material_login_register_text_color));
